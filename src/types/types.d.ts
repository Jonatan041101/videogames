export interface VideoGamesPages {
	count: number;
	description: string;
	filters: Filters;
	next: string;
...
export interface ResultPlatforms {
	games: GamePlatform[];
	games_count: number;
	id: number;
	image: null;
...
export interface FetchApiGames {
	videogames: VideoGamesPages;
	platforms: Platforms;
}
// ASSETS DE CADA GAME
